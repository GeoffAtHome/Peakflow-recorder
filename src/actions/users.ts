...
export interface UsersId extends Action<'USER_ID'> { _newUser: UsersItem, _index: string };
export interface UsersLoaded extends Action<'USER_DATA_LOADED'> { _data: Object };
export interface UsersAddUser extends Action<'ADD_USER'> { _newUser: UsersItem };
export interface UsersDeleteUser extends Action<'DELETE_USER'> { _newUser: UsersItem };
export interface UsersUpdateUser extends Action<'UPDATE_USER'> { _newUser: UsersItem };
export interface UsersSelectUser extends Action<'SELECT_USER'> { _newUser: UsersItem };

export type UsersAction = UsersId | UsersLoaded | UsersAddUser | UsersDeleteUser | UsersUpdateUser | UsersSelectUser;
